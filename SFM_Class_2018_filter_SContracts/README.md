...

{
 "cells": [
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "Please see the quantlet SFM_Class_2018_Scrape_API_SContracts and place the created there folder \"./sol_source\"  into root folder of this quanlet.\n",
    "As well as Ethereum.csv"
   ]
  },
  {
   "cell_type": "code",
